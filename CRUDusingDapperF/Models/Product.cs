...
namespace CRUDusingDapperF.Models
{
    public class Product
    {
        ...
        public static string ConnectionString = "Server=DESKTOP-LQC2102\\SQLEXPRESS;Database=ThinkQuotient;Integrated Security=True;";
    }
